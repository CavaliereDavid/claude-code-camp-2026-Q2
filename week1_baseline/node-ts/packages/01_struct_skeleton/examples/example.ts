...
import { loadConfig, tasks, userPromptsDir, PROMPTS_DIR, configToString } from "../src/config.js";
import { systemPrompt, TASK_NAME } from "../src/tasks/player.js";
...
const system = systemPrompt(playerSettings, {
  userPromptsDir: userPromptsDir(config),
  defaultPromptsDir: PROMPTS_DIR,
});

const ctx = createContext({ task: TASK_NAME, system });
